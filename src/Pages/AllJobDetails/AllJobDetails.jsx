...
const AllJobDetails = () => {
  const { user } = useContext(AuthContext);
     ...
     const handleSubmitApply=(e)=>{
      ...
      const newJobApply = { name,postId, link, details,img,jobTitle,category,location,postingDate,deadline,salaryRange,applicantsNumber,description}
        ...
        <div className="grid gap-4 gap-y-2  text-sm grid-cols-1 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="md:col-span-5">
                ...
                <input type="email" defaultValue={user.email}  name="email" id="email" className="dark:text-black h-10 border mt-1 rounded px-4 w-full bg-gray-50"/>
              </div>
            

              <div className="md:col-span-5">
                <label htmlFor="name" className=' text-white  font-semibold'></label>
                <input type="text" defaultValue={user.displayName}  name="name" id="name" className="dark:text-black h-10 border mt-1 rounded px-4 w-full bg-gray-50"/>
              </div>

              <div className="md:col-span-5">
                <label htmlFor="address" className=' text-white font-semibold'>Resume link</label>
                <input type="text" name="link" id="address" className="dark:text-black h-10 border mt-1 rounded px-4 w-full bg-gray-50" />
              </div>
              ...
              <div className="md:col-span-5">
                ...
                <div className=" bg-gray-50 flex border border-gray-200 rounded items-center mt-1">
                  <textarea name="details" id="country"className="dark:text-black p-2 h-28 appearance-none outline-none text-gray-800 w-full bg-transparent" />
                </div>
              </div>
