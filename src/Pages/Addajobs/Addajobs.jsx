...
<div className=" p-6  bg-gray-100 dark:bg-black flex items-center justify-center">
    ...
    <div>
      ...
      <div className="bg-[#3994e4] rounded shadow-lg p-4 px-4 md:p-8 mb-6">
        <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
          <div className="">
            <img src={jobsBanner} alt="" className=' h-full' />
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="md:col-span-5">
              ...
              <div className="md:col-span-1">
                <label htmlFor="address">Job Category</label>
              ...
              <div className="md:col-span-2">
                <label htmlFor="city" className=' block'>Posting Date</label>
