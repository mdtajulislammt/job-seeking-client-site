...
const Navbar = ( {theme,setTheme}) => {
     ...
     <li><NavLink to='/'  className={({ isActive, isPending }) =>
                isPending ? "pending" : isActive ? " text-[#3994e4] hover:text-[#000000]  hover:bg-[#00000000] text-lg font-thin  underline" : "text-lg font-thin "
              }>Home</NavLink></li>
     ...
     return (
          ...
          <NavLink className="  font-thin cursor-pointer bg-[#3994e4] text-white px-2 md:p-2 md:px-4 rounded-xl">LogIn</NavLink>

          <div className=" ml-4 bg-gray-200 rounded-full p-1 w-6 h-6 md:w-8 md:p-1 md:h-8">
