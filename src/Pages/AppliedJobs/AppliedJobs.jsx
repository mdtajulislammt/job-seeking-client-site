...
const AppliedJobs = () => {
     ...
     const handleJobsFilter =filter=>{
      if(selectJob){
       if(filter === 'all'){
       setSelectJob(applyJobs) 
      }
       else if(filter === 'On Site Job'){
        const onSiteJob = applyJobs.filter(job =>job.category === 'On Site Job' )
        setSelectJob(onSiteJob)
       }
       else if(filter === 'Remote Job'){
        const onSiteJob = applyJobs.filter(job =>job.category === 'Remote Job' )
        setSelectJob(onSiteJob)
       }
       else if(filter === 'Hybrid'){
        const onSiteJob = applyJobs.filter(job =>job.category === 'Hybrid' )
        setSelectJob(onSiteJob)
       }
       else if(filter === 'Part Time'){
        const onSiteJob = applyJobs.filter(job =>job.category === 'Part Time' )
        setSelectJob(onSiteJob)
       } }
      else{
        setSelectJob(applyJobs) 
