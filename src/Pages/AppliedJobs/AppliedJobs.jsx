...
const AppliedJobs = () => {
  ...
  useEffect(() => {
    axios
      .get("https://job-seeking-server-site.vercel.app/apply")
          ...
          <div className=" lg:flex justify-between  items-center -mb-3">
            ...
            <div className=" flex justify-center -mt-2 ">
              <TabList className="bg-[#3994e4] text-white px-[4px] pt-2 rounded-t-lg">
                ...
                <Tab onClick={() => handleJobsFilter("On Site Job")}>
                  On Site Job
                </Tab>
                <Tab onClick={() => handleJobsFilter("Remote Job")}>
                  Remote Job
                </Tab>
                <Tab onClick={() => handleJobsFilter("Hybrid")}>Hybrid</Tab>
                <Tab onClick={() => handleJobsFilter("Part Time")}>
                  Part Time
                </Tab>
              </TabList>
            </div>
            ...
            {selectJob.length == 0 ? (
              <>
                {filterData?.map((job) => (
                  <div
                    key={job._id}
                    className="card card-side bg-base-100 border-2 dark:bg-gray-400 dark:text-white p-5 border-[#3994e4] shadow-xl my-5"
                  >
                    <figure>
                      <img
                        src={job.img}
                    ...
                    <div className="ml-7 md:flex  justify-between items-center w-full ">
                      <div>
                        ...
                        <p className=" text-gray-500 dark:text-white font-semibold ">
                          Application Number : {job.applicantsNumber}
                        </p>
                      ...
                      <div className=" ">
                        <div className=" flex items-center gap-2 md:justify-end ">
                          <span className=" bg-[#3994e467] rounded-md p-2">
                            <AiOutlineHeart />
                          </span>
                          <Link>
                            <button
                              onClick={() => toPDF()}
                              className=" bg-[#3994e4] text-white p-2  px-7 rounded-md hover:text-black"
                            >
                              Resume Download
                            </button>
                          </Link>
                        ...
                        <p className="flex  items-center gap-2 dark:text-white text-gray-500 font-semibold mt-4 text-[12px] md:text-[13px]">
                          ...
                          <span>Date Line: {job.deadline}</span>
                        </p>
                        <p className="flex  items-center gap-2 dark:text-white text-gray-500 font-semibold  text-[12px] md:text-[13px]">
                          <span>
                            <SlCalender className=" text-black text-[8px] md:text-[16px] mb-1 dark:text-white" />
                          </span>{" "}
                          <span>Posting : {job.postingDate}</span>
                        </p>
