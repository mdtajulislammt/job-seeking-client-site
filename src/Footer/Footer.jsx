...
<footer className="bg-black text-white dark:bg-[#242323]">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <Link to={'/'} className="flex items-center">
                  ...
                  <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Searching Jobs</span>
              </Link>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      ...
                      <li>
                          <a  className="hover:underline">Our Services</a>
                      </li>
                  </ul>
              </div>
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li>
                          <a  className="hover:underline">0199 XXX XX XX</a>
                      </li>
                      <li>
                          <a  className="hover:underline">Dhaka,Gazipur</a>
                      </li>
                      <li className="mb-4">
                          <a  className="hover:underline text-[12px]">mdtajulislammt505@hamil.com</a>
                      </li>
                  </ul>
              </div>
              <div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a className="hover:underline">Searching Jobs</a>. All Rights Reserved.Design by <a href="" className="hover:underline text-white"> MD Tajul Islam</a>
          </span>
